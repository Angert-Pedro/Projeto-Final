...
namespace API.Services
{
    public class BaseService<T> : DescriptografiaAES where T : class
    {
        ...
        // métodos existentes em estilo camelCase (mantidos para compatibilidade interna)
        ...
        // Adicionadas versões PascalCase para compatibilidade com controllers
        public void Inserir(T entidade) => inserir(entidade);
        public IEnumerable<T> Listar() => listar();
    }
}